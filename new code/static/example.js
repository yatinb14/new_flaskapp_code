...
function update_total() {
  ...
  var subtotal1=total + (total * 0.18);
  console.log("subtotal1 is "+ subtotal1);
  total = roundNumber(total,2);
  subtotal = roundNumber(subtotal1,2);
  words1=Math.round(subtotal);
  words=convertNumberToWords(words1);
  console.log("number is"+ words);
  var newgst = subtotal - total;
  newgst = roundNumber(newgst,2) 
  console.log("gst is "+ newgst);
